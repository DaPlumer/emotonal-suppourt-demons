...
public class ModItems {
    public static final Item DEMON_SPAWN_EGG = registerItem("demon_spawn_egg", new ShamelessPromotion(ModEntities.DEMON, 0xa53543, 0x545452,new Item.Settings().maxCount(1)));
    ...
    public static void registerItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.SPAWN_EGGS).register((content) -> {
            content.add(DEMON_SPAWN_EGG.getDefaultStack());
        });
    }
}
